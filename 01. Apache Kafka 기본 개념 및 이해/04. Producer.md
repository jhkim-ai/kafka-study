...
![Producer & Consumer 기본 동작](../img/part1/ch1/04_01_Producer와Consumer_기본동작.PNG "Producer & Consumer 기본 동작")
...
![Record 구조](../img/part1/ch1/04_02_Recode구조.PNG "Record 구조")
...
![ByteArray로 저장](../img/part1/ch1/04_03_ByteArray저장.PNG "ByteArray로 저장")
...
![Producer 작동 과정](../img/part1/ch1/04_04_Producer작동과정.PNG "Producer 작동 과정")
...
![Key가 Null이 아닐 때의 Default Partitioner](../img/part1/ch1/04_05_Default_Partitioner_Not_null.PNG "Key가 Null이 아닐 때의 Default Partitioner")
...
![Key가 Null일 때의 Default Partitioner](../img/part1/ch1/04_06_Default_Partitioner_null.PNG "Key가 Null일 때의 Default Partitioner")
